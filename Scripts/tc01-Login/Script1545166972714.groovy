...
WebUI.click(findTestObject('Object Repository/login/Page_CURA Healthcare Service/span_Visit Date (Required)_gly'))

WebUI.click(findTestObject('Object Repository/login/Page_CURA Healthcare Service/div_Apply for hospital readmis'))
