...
WebUI.click(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/td_27'))
...
WebUI.click(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/div_Appointment Confirmation'))

WebUI.click(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/footer_CURA Healthcare Service'))
